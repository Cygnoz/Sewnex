...
export const settingsList = [
  ...
  },
  {
    ...
    icon: ListIcon,
    subhead: [
      { headName: "order", subRoute: "/settings/orders/ordersettings" },
    ],
  },
  {
    nav: "Items",
    icon: Frame,
    subhead: [{ headName: "Item", subRoute: "/settings/items/item" }],
  },
  {
    nav: "Tax & Compliance",
    icon: Building,
    subhead: [
      ...
      {
        headName: "MSME Settings",
        subRoute: "/settings/tax-compliance/msme-settings",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subhead: [
      ...
      {
        headName: "Refer & Earn",
        subRoute: "/settings/rewards-settings/refer-earn",
      },
      {
