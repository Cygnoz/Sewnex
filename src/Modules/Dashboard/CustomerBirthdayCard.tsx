  ...
  return (
    <>
      <div className="flex p-4 rounded-md">
        ...
        <div className="relative w-full max-w-4xl bg-[#D9E4E4] h-40 rounded-2xl overflow-hidden cursor-pointer" onClick={handleCardClick}>
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${birthdaycard1img})`,
            }}
          />
          ...
          <div className="relative flex flex-col p-6 w-full h-full">
            ...
            <div className="flex items-center justify-start mb-4">
              <h2 className="text-[#004d4d] text-xl font-bold">Today's Customer Birthday</h2>
              {/* Avatar Row */}
      ...
      <Modal open={isModalOpen} onClose={handleCloseModal}>
        <div className="p-6">
          <h3 className="text-xl font-bold mb-4">Today's Customer Birthday</h3>
...
export default CustomerBirthdayCard
