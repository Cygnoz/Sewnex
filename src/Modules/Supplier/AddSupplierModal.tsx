...
function AddSupplierModal({ page,id }: Props) {
    ...
    const getBorderClassName = (tabName: string) => {
        return activeTab === tabName ? "border-[#054928]" : "border-neutral-300";
    };
                ...
                <Modal className="w-[1200px]" open={isModalOpen} onClose={closeModal}>
                    <div className="p-5 mt-3">
                        ...
                        <form
                            ...
                            style={{ height: "480px" }}
                        >
                            <div className="gride grid-cols-12 gap-4">
                                <div className="flex gap-5 px-6">
                                    <div className="col-span-2">
                                        <div className=" border border-[#B47300] border-dashed rounded-lg items-center justify-center flex text-center py-3 w-[180px]  h-[240px] ">
                                            ...
                                            <div className="col-span-2">
                                                ...
                                                <div className="relative w-full">
                                                    <select
                                                        ...
                                                        className="block appearance-none text-[#818894] w-full h-9 mt-1  bg-white border border-inputBorder text-sm pl-3 pr-8 rounded-3xl leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                    >
                                            ...
                                            <div className="grid grid-cols-2 col-span-10 gap-4 ">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        type="text"
                                                        name="firstName"
                                                        className="pl-3 text-sm w-[100%] mt-1 rounded-3xl text-start bg-white border border-slate-300 h-9 p-2 text-[#818894]"
                                        ...
                                        <ul className="h-full   space-y-0">
                                            <li
                                                className={`${getTabClassName(
                                                    "otherDetails"
                                                )} border-r-4 ${activeTab === "otherDetails" ? "text-[#075E33]" : "text-[#495160]"} ${getBorderClassName("otherDetails")} p-2 `}
                                            ...
                                            <li
                                                className={`${getTabClassName(
                                                    "taxes"
                                                )} border-r-4 ${activeTab === "taxes" ? "text-[#075E33]" : "text-[#495160]"} ${getBorderClassName("taxes")} p-2 `}
                                            ...
                                            <li
                                                className={`${getTabClassName(
                                                    "address"
                                                )} border-r-4 ${activeTab === "address" ? "text-[#075E33]" : "text-[#495160]"} ${getBorderClassName("address")} p-2`}
                                            ...
                                            <li
                                                className={`${getTabClassName(
                                                    "contactPersons"
                                                )} border-r-4 ${activeTab === "contactPersons" ? "text-[#075E33]" : "text-[#495160]"} ${getBorderClassName(
                                                    "contactPersons"
                                                )} p-2`}
                                            ...
                                            <li
                                                className={`${getTabClassName(
                                                    "bankDetails"
                                                )} border-r-4 ${activeTab === "bankDetails" ? "text-[#075E33]" : "text-[#495160]"} ${getBorderClassName("bankDetails")} p-2`}
                                            ...
                                            <div className="space-y-4 ">
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div>
                                                        ...
                                                        <input
                                                            type="text"
                                                            className=" text-sm w-[100%]  rounded-3xl text-start bg-white border border-slate-300  h-9 px-3 py-2 text-[#818894]"
                                                    ...
                                                    <div>
                                                        <div className="">
                                                            ...
                                                            <div className="relative w-full">
                                                                <select
                                                                    className="block appearance-none w-full h-9  text-[#818894] bg-white border border-inputBorder text-sm  pl-3 pr-8 rounded-3xl leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                                    name="currency"
                                                    ...
                                                    <div>
                                                        ...
                                                        <select
                                                            className="block appearance-none w-full h-9 text-[#818894] bg-white border border-inputBorder   text-sm pl-2 pr-8 rounded-3xl leading-tight  focus:outline-none focus:bg-white focus:border-gray-500"
                                                            name="paymentTerms"
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="relative w-full">
                                                            <select className="block appearance-none w-full h-9  text-[#818894] bg-white border border-inputBorder text-sm  pl-3 pr-8 rounded-3xl leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                                                <option value="" className="text-gray">
                                                                    {" "}
                                                                    Select a Tax
                                                                </option>
                                                ...
                                                <div className="grid grid-cols-3 gap-4">
                                                    <div>
                                                        ...
                                                        <input
                                                            type="text"
                                                            className=" text-sm w-[100%]  rounded-3xl text-start bg-white border border-slate-300  h-p  px-3 py-2 text-[#818894] "
                                                ...
                                                <div className="">
                                                    ...
                                                    <div className="relative w-full">
                                                        ...
                                                        <input
                                                            type="text"
                                                            className=" text-sm w-[49%] ps-9 rounded-3xl text-start bg-white border border-slate-300  h-9  px-3 py-2 text-[#818894]"
                                                            placeholder="Value"
                                                            name="websiteURL"
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        type="text"
                                                        className=" text-sm w-[48%]  rounded-3xl text-start bg-white border border-slate-300  h-p  px-3 py-2 text-[#818894]"
                                        ...
                                        {activeTab === "taxes" && (
                                            <>
                                                ...
                                                <div className="w-6/12 py-2">
                                                    ...
                                                    <input
                                                        type="text"
                                                        className="pl-2 text-sm w-full rounded-3xl text-start bg-white border border-slate-300 h-9 p-2 text-[#818894]"
                             ...
                             />
                                            ...
                                            <>
                                                ...
                                                <div className="space-y-3 text-sm">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input
                                                                type="text"
                                                                className="pl-2 text-sm w-full rounded-3xl text-start bg-white border border-slate-300 h-9  px-3 py-2 text-[#818894]"
                                                                placeholder="Enter Attention"
                                                                name="billingAttention"
                                                                value={supplierdata.billingAttention}
                                                                onChange={handleChange}
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div>
                                                            <input
                                                                className="pl-3 text-sm w-full text-[#818894] rounded-3xl text-start bg-white border border-inputBorder h-[39px] leading-tight focus:outline-none focus:bg-white focus:border-darkRed"
                                                        ...
                                                        <div>
                                                            <input
                                                                className="pl-3 text-sm w-full text-[#818894] rounded-3xl text-start bg-white border border-inputBorder h-[39px]  px-3 py-2 leading-tight focus:outline-none focus:bg-white focus:border-darkRed"
                                                        ...
                                                        <div>
                                                            ...
                                                            <input
                                                                className="pl-3 text-sm w-full text-[#818894] rounded-3xl text-start bg-white border border-inputBorder h-[39px]  px-3 py-2 mt-2 leading-tight focus:outline-none focus:bg-white focus:border-darkRed"
                                                        ...
                                                        <div className="relative ">
                                                            ...
                                                            <div className="relative w-full mt-2">
                                                                <select
                                                                    ...
                                                                    name="billingState"
                                                                    id="billingState"
                                                                    className="block appearance-none w-full text-[#818894] bg-white border border-inputBorder text-sm h-[39px] pl-3 pr-8 rounded-3xl leading-tight focus:outline-none focus:bg-white focus:border-darkRed"
                                                ...
                                                <div className="space-y-3 p-5 text-sm">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4">
                                                        ...
                                                        <div>
                                                            <input
                                                                className="pl-3 text-sm w-full text-[#818894] rounded-3xl text-start bg-white border border-inputBorder h-[39px] p-2 leading-tight focus:outline-none focus:bg-white focus:border-darkRed"
                                                                placeholder="Street 2"
                                        ...
                                        {activeTab === "bankDetails" && (
                                            <div className="">
                                                ...
                                                >
                                                    <Plus color="darkRed" /> Add New Bank
                                                    Account
                                                </div>
                                            </div>
                                        )}
