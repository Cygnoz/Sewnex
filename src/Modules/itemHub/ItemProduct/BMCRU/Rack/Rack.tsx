...
const Rack = () => {
  ...
  const filteredRackData = allRackData.filter((rack:any) =>
    rack.rackName.toLowerCase().includes(searchValue.toLowerCase())
  );
  useEffect(() => {
    loadracks();
  }, [bmcrResponse]);
  ...
  return (
    <>
      ...
      >
        ...
        {filteredRackData.length > 0 ? (
          <div className="grid grid-cols-3 gap-4 mt-3">
            {filteredRackData.map((rack: any) => (
              <div
              ...
              >
                <div className="flex gap-2">
                  ...
                  <div className="flex gap-1 ml-auto items-start justify-center">
                    <div className="-mt-1">
                      {" "}
